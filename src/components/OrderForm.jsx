...
const inputClass = (hasError) =>
  `w-full bg-gray-800 border ${
    hasError ? 'border-red-500/70' : 'border-gray-700 focus:border-blue-600'
    ...
    <section id="pedido" ref={formRef} className="py-14 sm:py-20 bg-gray-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-blue-600 font-semibold text-sm uppercase tracking-widest">Pedido</span>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-600/30 flex items-center justify-center gap-3 mt-2"
          >
          ...
          {sent && (
            <div className="bg-blue-600/10 border border-blue-600/30 text-green-400 rounded-xl p-4 text-center text-sm font-medium">
