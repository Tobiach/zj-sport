    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-28 sm:pb-24 w-full">
        <div className="max-w-xl">
          ...
          <div className="inline-flex items-center gap-2 border border-blue-500/25 bg-blue-500/10 text-blue-400 px-3 py-1.5 rounded-full text-xs font-semibold mb-6 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-black px-7 py-4 rounded-2xl text-base transition-all active:scale-95 hover:scale-[1.03] hover:shadow-2xl hover:shadow-blue-600/40 flex items-center justify-center gap-2.5"
            >
